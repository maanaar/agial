      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 border-l border-gray-200 pl-6">
          ...
          <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden border border-gray-100">
            {/* Generic avatar placeholder that resembles the one in the image */}
            <svg viewBox="0 0 36 36" fill="none" role="img" xmlns="http://www.w3.org/2000/svg" width="40" height="40">
              <mask id="mask__beam" maskUnits="userSpaceOnUse" x="0" y="0" width="36" height="36">
                <rect width="36" height="36" rx="72" fill="#FFFFFF"></rect>
              </mask>
              <g mask="url(#mask__beam)">
                <rect width="36" height="36" fill="#f8f9fa"></rect>
                <rect x="0" y="0" width="36" height="36" transform="translate(7 -1) rotate(195 18 18) scale(1.1)" fill="#e9ecef" rx="6"></rect>
                <g transform="translate(3 -4) rotate(5 18 18)">
                  <path d="M15 19c2 1 4 1 6 0" stroke="#adb5bd" fill="none" strokeLinecap="round"></path>
                  <rect x="10" y="14" width="1.5" height="2" rx="1" stroke="none" fill="#adb5bd"></rect>
                  <rect x="24" y="14" width="1.5" height="2" rx="1" stroke="none" fill="#adb5bd"></rect>
                </g>
              </g>
            </svg>
          </div>

    ...
    <div className="min-h-screen bg-[#F6F6F6] p-6 lg:p-8 font-sans text-gray-900">
      <div className="max-w-[1280px] mx-auto">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-500 mb-2">
          ...
          <span className="text-gray-400">Medical Desktop</span>
        </nav>

        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <h1 className="text-3xl font-bold text-slate-800">Patient Summary</h1>
        ...
        <div className="bg-[#FFF9E6] border border-[#FFE8A3] rounded-xl p-4 mb-8 flex gap-3 shadow-sm">
          ...
          <div>
            ...
            <p className="text-[#856404] text-sm opacity-90 leading-relaxed">
              Monitor BP closely due to previous hypertensive readings. Patient is allergic to Penicillin. Ensure regular follow-ups for medication adjustment.
            </p>
          </div>
        </div>

...
const DEV_MOCK = {
  ...
  queue: [
    { id: 1, level: 'L1', name: 'Marcus Johnson', gender_note: 'Unknown Male', elapsed: '12m elapsed', bed: 'Trauma 1', doctor: 'Dr. Sarah Jenkins', triage_category: 'Resuscitation', status_label: 'CPR in Progress',   status_type: 'critical' },
    { id: 2, level: 'L2', name: 'Elena Rodriguez', gender_note: null,          elapsed: '34m elapsed', bed: 'ER-04',    doctor: 'Dr. Michael Chen',  triage_category: 'Emergent',      status_label: 'Awaiting CT Scan', status_type: 'warning'  },
    { id: 3, level: 'L3', name: 'David Smith',     gender_note: null,          elapsed: '1h 12m elapsed', bed: 'ER-07', doctor: 'Dr. Emily Wong',   triage_category: 'Urgent',        status_label: 'Lab Results Ready', status_type: 'info'   },
    { id: 4, level: 'L3', name: 'Amanda Clark',    gender_note: null,          elapsed: '24m elapsed', bed: 'Waiting Area', doctor: null,            triage_category: 'Urgent',        status_label: 'To Be Seen',       status_type: 'warning'  },
    { id: 5, level: 'L4', name: 'Robert Kim',      gender_note: null,          elapsed: '48m elapsed', bed: 'ER-11',   doctor: 'Dr. Emily Wong',    triage_category: 'Semi-Urgent',   status_label: 'Vitals Stable',    status_type: 'info'   },
  ],
  staff: [
    { id: 1, name: 'Dr. Sarah Jenkins', role: 'Attending / Trauma',  status: 'available', avatar: null },
    { id: 2, name: 'Dr. Michael Chen',  role: 'ER Physician',        status: 'busy',      avatar: null },
    { id: 3, name: 'RN. Lisa Washington', role: 'Charge Nurse',      status: 'available', avatar: null },
  ],
  arrivals: [
    { id: 1, label: 'Ambulance 104', eta: '4 mins', note: 'MVA, 2 casualties, suspected spinal trauma. Prepare Trauma Bay 2.' },
  ],
}

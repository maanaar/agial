...
const medicationsRows = [
  {
    drug:     { type: "multi", title: "Augmentin 1g Tablet", subtitle: "Amoxicillin / Clavulanate Potassium" },
    dose:     "1 Tab, BID",
    route:    "Oral",
    duration: "7 Days",
  ...
  {
    drug:     { type: "multi", title: "Panadol Advance 500mg", subtitle: "Paracetamol" },
    dose:     "1 Tab, PRN",
    route:    "Oral",
    duration: "5 Days",
    status:   { type: "badge", value: "Active" },
  ...
  {
    drug:     { type: "multi", title: "Amoxicillin 500mg Capsule", subtitle: "Amoxicillin" },
    dose:     "1 Cap, TID",
    route:    "Oral",
    duration: "5 Days",
...
// ];
  return (
    <div>
      <div>
        <div>
 <PageHeader title="Medication Record" tx="Active Prescriptions" no="2"/>
        </div>
        <div>
